    ...
    <>
        ...
        actions={
          <>
            <Button variant="outline" asChild>
              <Link href="/xml-parser/saved">{t(dict, 'common.back')}</Link>
            </Button>
            <form action={deleteSnippet}>
              <input type="hidden" name="id" value={snippet.id} />
              <input type="hidden" name="snippet_type" value="xml" />
      ...
      <DetailSectionCard className="mb-5" title={t(dict, 'parser.snippetTitle')}>
        <DetailMetadata>
          ...
          <DetailItem label={t(dict, 'common.type')} value="XML" valueClassName="font-mono" />
