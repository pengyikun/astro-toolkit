  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Button asChild>
            <Link href="/transactions/new">{t(dict, 'transactions.newTransaction')}</Link>
          </Button>
        }
      />
                    ...
                    <TableCell data-label={t(dict, 'common.actions')} data-cell-actions="true" className="text-right">
                      <div className="table-actions justify-end">
                        <Button asChild size="sm" variant="outline">
                          <Link href={`/transactions/${log.id}`}>{t(dict, 'common.view')}</Link>
                        </Button>
                        <Button asChild size="sm" variant="outline">
                          <Link href={`/transactions/${log.id}/edit`}>{t(dict, 'common.edit')}</Link>
                        </Button>
